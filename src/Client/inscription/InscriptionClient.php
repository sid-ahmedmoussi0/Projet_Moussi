            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="form" action="./InscriptionClientBD.php">
                            ...
                            <div class="form-group form-button">
                                <button class="form-submit" type="submit" name="signup" id="signup">Inscription</button>
                            </div>
