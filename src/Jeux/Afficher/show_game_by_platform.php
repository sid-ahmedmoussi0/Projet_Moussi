    ...
    <div class="container mt-5">
        <div class="row">
            ...
            try {
                ...
                WHERE jp.plateforme_id =$plat_id
                ORDER BY j.j_id");
            ...
            ?>
                        <div class="col-md-3">
                            <div class="card card.<?php echo $plateforme; ?>">
                                <a href="show_game_details.php?id=<?php echo $jeu['j_id']; ?>&plateforme_id=<?php echo $plateforme_id; ?>">
                                    <span class="info-icon info"><i class="fa fa-heart-o fa-lg"></i></span>
                                    </label>
                                </a>
